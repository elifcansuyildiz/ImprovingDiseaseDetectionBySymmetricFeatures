...
from medai.utils.loss import ContrastiveLoss, ContrastiveLoss2, ContrastiveLoss3
...
def objective(trial):
    ...
    lmbda = trial.suggest_float('lmbda', 0.15, 1.55)
...
def main():
    search_space = {
                    'lmbda': [0.2, 0.4, 0.6, 0.8, 1.2, 1.4]
                    }
    study = optuna.create_study(storage="sqlite:///db.sqlite3",
                                study_name="LambdaTuning",
                                direction="maximize",
